...
def train():
    ...
    train_log_dir = './logs_no/train/'
    val_log_dir = './logs_no/val/'
    ...
    logits = VGG.VGG16_BN(x, N_CLASSES, IS_PRETRAIN)
...
print("using time is %.3f minute"%time)



####  用VGG参数初始化，然后全部参数重新训练，test_accuracy = 0.6417
####  保留VGG卷积层参数，训练3个全连接层，test_accuracy = 0.8507